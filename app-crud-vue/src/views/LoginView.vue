<template>
  <div class="min-vh-100 d-flex align-items-center justify-content-center" style="background:linear-gradient(232deg, #0dcaf0a1 0%, #75b798 100%
100%
);">
    <div class="col-md-5">
      <div class="card border-0 shadow-lg" style="border-radius: 15px;">
        <div class="card-body p-5">
          ...
          <form @submit.prevent="iniciarSesion">
            <div class="mb-4">
              <label class="form-label card-title fw-bold text-primary text-dark">
            ...
            style="border-radius: 10px; background: linear-gradient(232deg, #0dcaf0a1 0%, #75b798 100% 100%); border: none;"
            >
          ...
          <div class="text-center mt-4">
            <small class="text-muted">Usa: admin / 123</small>
          </div>
        </div>
      </div>
    </div>
...
.card:hover {
  ...
  box-shadow: 0 10px 40px rgba(94, 86, 86, 0.15) !important;
}
</style>
