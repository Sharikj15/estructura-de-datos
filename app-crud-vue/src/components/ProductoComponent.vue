<template>
  <div class="card border-0 shadow-sm" style="border-radius: 15px;">
    <div class="card-header bg-gradient" style="background:  linear-gradient(7deg, rgb(102 234 164) 0%, rgb(75 82 162) 100%); border-radius: 15px 15px 0 0; color:#8fd3f4; padding: 1.5rem;">
    ...
    <div class="card-body p-4">
      <form @submit.prevent="agregarProducto" class="mb-4">
        <div class="row g-3 mb-3">
          <div class="col-md-5">
            <label class="form-label fw-600"><i class="bi bi-tag-fill"></i> Nombre Producto</label>
            <input
              v-model="nombre"
  ...
  <div v-if="showDeleteModal" class="modal-overlay">
    ...
    <div class="modal d-block" tabindex="-1">
      <div class="modal-dialog">
        <div class="modal-content shadow-lg" style="border-radius: 15px; border: none;">
          <div class="modal-header" style="background: linear-gradient(232deg, #0dcaf0a1 0%, #75b798 100% 100%); color:#8fd3f4 ;border-radius: 15px 15px 0 0; border: none;">
